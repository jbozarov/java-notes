...
Method overriding is child class uses own method which is a same as name of parent class's method ( you change ) 
...
Method overloading ( happens within the class ) so class uses same name to create multiple methods with different parameters 
  ...
  JS has not overloading, last method will be invoked But Java will invoke the one which number of parameters match 
